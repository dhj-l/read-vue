    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-4">
      <div class="flex justify-between items-center">
        <div class="flex space-x-2">
          ...
          <el-button type="primary" icon="search" @click="getChapters"
            >搜索</el-button
          >
      ...
      <el-table border stripe class="h-full" :data="list" v-loading="loading">
        ...
        >
          <template #="{ row }">
            ...
            <template v-else-if="column.prop === 'work'">
    ...
    <el-drawer v-model="detailDrawer" :title="detailTitle" :size="600">
      <div class="p-4 space-y-4">
        <el-descriptions :column="2" border>
          ...
          <el-descriptions-item label="所属作品">{{
            detail?.work?.title
          }}</el-descriptions-item>
        ...
        <div>
          ...
          <div class="p-3 border rounded whitespace-pre-line">
            {{ detail?.content }}
          </div>
        </div>
      </div>
